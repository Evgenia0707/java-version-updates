...
public class TakeWhileDropWhile {
    public static void main(String[] args) {
        ...
        System.out.println("Stocks sorted: \n" + stocks);//[Stock{name='Instagram', value=100},..
...
//Using takeWhile
        ...
        System.out.println("Filter output:" + stockBelow500);//takeWhile processing : Stock{name='Instagram', value=100}

//Using dropWhile

        List<String> stockAbove500 = getStocksAboveFiveHundred(stocks);
        System.out.println("Filter output:" + stockAbove500);//drops all the matching ones
    }
